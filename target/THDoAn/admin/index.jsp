                    ...
                    <div class="row">
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-danger card-img-holder text-white">
                                <div class="card-body">
                                    ...
                                    <h4 class="font-weight-normal mb-3"> Doanh số hàng tháng <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                                    </h4>
                        ...
                        <div class="col-md-4 stretch-card grid-margin">
                            <div class="card bg-gradient-info card-img-holder text-white">
                                <div class="card-body">
                                    <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                                    <h4 class="font-weight-normal mb-3">Số đơn hàng tháng <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                                    </h4>
                                    <h2 class="mb-5">28</h2>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="assets/images/180-LI(Q).jpg" class="me-2" alt="image"> Máy khoan 180-LI
                                                    </td>
                                                    <td> Khoan mini </td>
                                                    <td>
                                                        <label class="badge badge-gradient-success"> 980.000 đ</label>
                                                    </td>
                                                    <td> 19/6/2022 </td>
                                                    <td> WD-12345 </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <img src="assets/images/may-khoan-bosch-gbm-320(1q).jpg" class="me-2" alt="image"> Máy khoan Bosch GBM-320
                                                    </td>
                                                    <td> Khoan mini </td>
                                                    <td>
                                                        <label class="badge badge-gradient-warning">1.290.000 đ</label>
                                                    </td>
                                                    <td> 28/8/2022 </td>
                                                    <td> WD-12346 </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <img src="assets/images/may-khoan-bua-bosch-gbh-2-24-dfr-300(2q).jpg" class="me-2" alt="image"> Máy khoan Bosch GBM-24
                                                    </td>
                                                    <td> Khoan mini </td>
                                                    <td>
                                                        <label class="badge badge-gradient-info">590.000</label>
                                                    </td>
                                                    <td> 28/6/2022 </td>
                                                    <td> WD-12347 </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <img src="assets/images/may-khoan-bosch-gbm-350-a(4q).jpg" class="me-2" alt="image"> Máy khoan Bosch GBM-350
                                                    </td>
                                                    <td> Khoan mini </td>
                                                    <td>
                                                        <label class="badge badge-gradient-danger">920.000</label>
                                                    </td>
                                                    <td> 19/9/2022 </td>
                                                    <td> WD-12348 </td>
                                                </tr>
