            ...
            <ul class="header-links pull-right">
                ...
                <div class="dropdown">
                    <div style="cursor: pointer">
                        <li><a href="/lichsu"><i class="fa fa-user-o"></i>Chào bạn: <%= auth.getUser_fullname()%><i
                                class="fa fa-caret-down" style="color:#f0e2ff;"></i></a></li>
                    </div>
    ...
    <div class="container">
        ...
        <div id="responsive-nav">
            ...
            <ul class="main-nav nav navbar-nav">
                ...
                <li><a href="<%= "/category?cName=" + p.getcName()%>"><%= p.getcName()%>
                </a></li>
                <% } %>
                <%--                    <%if(auth!=null){%>--%>
                ...
                <div id="product-main-img">
                    <div id="myCarousel">
                        <div class="carousel-item">
                            <img src="<%=p.getImg()%>" alt="Image 1">
                        </div>
                        <div class="carousel-item">
                            <img src="<%=p.getImg2()%>" alt="Image 2">
                        </div>
                        <div class="carousel-item">
                            <img src="<%=p.getImg3()%>" alt="Image 3">
                        </div>
                        <div class="carousel-item">
                            <img src="<%=p.getImg4()%>" alt="Image 4">
                        </div>
                    </div>
...
<%--                    </div>--%>
            ...
            <div class="col-md-5">
                ...
                <div class="product-details">
                    ...
                    <h2 class="product-name"><%= p.getName()%>
                    </h2>
                    <div>
                    ...
                    <div class="add-to-cart">
                        ...
                        <button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i><a
                                href="<%="/addToCart?id=" + p.getId()%>"> Thêm vào giỏ hàng</a></button>
                    </div>
                                        ...
                                        <ul class="reviews">
                                            ...
                                            <li>
                                                <div class="review-heading">
                                                    <h5 class="name"><%=c.getUser_fullname()%>
                                                    </h5>
                                                    <p class="date"><%=c.getNgayTao()%>
                                                    </p>
                                ...
                                <div class="col-md-3">
                                    <div id="review-form">
                                        <form class="review-form" method="post" action="/Comment">
                                            ...
                                            <input class="date" name="dateComment" style="display: none"
                                                   value="<%=currentDate.toString()%>" type="text">


                                            <input class="input" name="userIdComment" style="display: none"
                                                   value="<%= auth.getUser_id()%>" type="text">


                                            <input class="input" name="productIdComment" style="display: none"
                                                   value="<%=p.getId()%>" type="text">
                                            <textarea class="input" name="textComment"
                                                      placeholder="Viết đánh giá của bạn"></textarea>
                                            <div class="input-rating">
                                                <span>Xếp hạng: </span>
                                                <div class="stars">
                                                    <input id="star5" name="ratingComment" value="5" type="radio"><label
                                                        for="star5"></label>
                                                    <input id="star4" name="ratingComment" value="4" type="radio"><label
                                                        for="star4"></label>
                                                    <input id="star3" name="ratingComment" value="3" type="radio"><label
                                                        for="star3"></label>
                                                    <input id="star2" name="ratingComment" value="2" type="radio"><label
                                                        for="star2"></label>
                                                    <input id="star1" name="ratingComment" value="1" type="radio"><label
                                                        for="star1"></label>
                                                </div>
                                            </div>
            ...
            <div class="col-md-3 col-xs-6">
                <div class="product">
                    ...
                    <div class="product-body">
                        <p class="product-category"><%= n.getClassify()%>
                        </p>
                        <h3 class="product-name"><a href="<%= "/detail?id=" + n.getId()%>"><%= n.getName()%>
                        </a></h3>
                        <h4 class="product-price"><%=tt%>đ
                            <del class="product-old-price"><%= n.getOldPrice()%>
                            </del>
                        </h4>
                        <div class="product-btns">
                            ...
                            <button class="add-to-compare"><i class="fa fa-exchange"></i><span
                                    class="tooltipp"> so sách</span></button>
                            <button class="quick-view"><a href="<%= "/detail?id=" + n.getId()%>" class=""> <i
