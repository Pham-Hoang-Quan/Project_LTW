            ...
            <ul class="header-links pull-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
                        ...
                        <span style="cursor: pointer;">Chào bạn: <%= auth.getUser_fullname()%>
                            <i class="fa fa-caret-down" style="color:#f0e2ff;"></i></span>
                    </a>
...
<div class="login-form signup-form">
    <form action="/THDoAn_war/dologin" method="post">
        ...
        <div class="clearfix">
            <label class="float-left form-check-label"><input type="checkbox" name="remember" id="remember">Nhớ tài
                khoản?</label>
