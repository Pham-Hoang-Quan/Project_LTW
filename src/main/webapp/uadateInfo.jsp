...
<div class="profile-container">
    ...
    <div class="profile-content">
        ...
        <p style="color: #938c8c">chỉnh sửa thông tin hồ sơ</p>
<form action="/update-fullname" method="post">
        <div class="gach-ngang"></div>
    <input type="text" class="input-update" style="display: none" name="user_id" value="<%=auth.getUser_id()%>">
    <p class="alert-danger">${messerger}</p>
        <div class="profile-info">
            <p>Tên đăng nhập:</p>
            <input type="text" class="input-update" name="user_name" value="<%=auth.getUser_name()%>">
            <p>Số điện thoại:</p>
            <input type="text" class="input-update" name="user_sdt" value="<%=auth.getUser_sdt()%>">
            <p>Họ và Tên:</p>
            <input type="text" class="input-update" name="user_fullnameN" value="<%=auth.getUser_fullname()%>">
            <p>Email:</p>
            <input type="text" class="input-update" name="user_email" value="<%=auth.getEmail()%>">
            <p>Tài Khoản:</p>
            <input type="text" class="input-update" name="account" value="<%=auth.getAccount()%>">
            <p>Mật khẩu cũ:</p>
            <input type="password"  class="input-update"  name="enterpass_old" value="" required="required">
            ...
            <p>Mật khẩu mới:</p>
            <input type="password" id="password" class="input-update" name="user_passNew" value="" required="required"  oninput="hideParagraph()" >
            <h5 id="password-length-message"></h5>
            <h5 id="password-special-char-message"></h5>
            <button type="submit" class="button-dep">Lưu</button>

            <input type="text" class="input-update" style="display: none" name="pass_old" value="<%=auth.getUser_password()%>">
        </div>
</form>
    </div>
</div>
