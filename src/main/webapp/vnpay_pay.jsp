    ...
    <div class="table-responsive">
        <form action="/ajaxServlet" id="frmCreateOrder" method="post">
            <div class="form-group">
                <label for="amount">Số tiền: <%=price%></label>
                <input style="display: none" class="form-control" data-val="true" data-val-number="The field Amount must be a number." data-val-required="The Amount field is required." id="amount" name="amount" type="number" value="<%=price%>" />
            </div>
            <h4>Chọn phương thức thanh toán</h4>
            <div class="form-group">
                <h5>Cách 1: Chuyển hướng sang Cổng VNPAY chọn phương thức thanh toán</h5>
                <input type="radio" style="background-color: #D10024 " Checked="True" id="bankCode" name="bankCode" value="">
            ...
            <button type="submit" class="btn btn-default" style="background: #D10024; color: #0b0c0d" href>Thanh toán</button>
        </form>
    </div>
